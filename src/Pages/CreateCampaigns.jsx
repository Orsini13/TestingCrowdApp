    ...
    <AnimatedPage>
      <div className="bg-[#1c1c24] flex justify-center items-center flex-col rounded-[10px] sm:p-10 p-4">
        ...
        <div className="flex justify-center items-center p-[16px] sm:min-w-[380px] b-[#3a3a43] rounded-[10px]">
          <h1 className=" font-bold sm:text-[25px] text-[10px] leading-[36px] text-white">
            Start a campaign
          </h1>
        </div>
        ...
        >
          ...
          <h4 className='text-white  font-bold text-[25px] ml-[20px]'>You will get 100% of the money raised</h4>
        </div> */}
