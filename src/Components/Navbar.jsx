    ...
    <div className="flex md:flex-row flex-col-reverse justify-between mb-[30px] gap-6">
      ...
      {/* <div className="lg:flex-1 flex flex-row  max-w-[458px] py-2 pl-4 pr-2 h-[52px] bg-[#1c1c24] rounded-[100px] ">
        <input
          ...
          className="flex w-full  font-normal text-[14px] placeholder:text-[#557188] text-white bg-transparent outline-none placeholder:p-2"
        />
      ...
      <div className="sm:flex hidden flex-row justify-end gap-4">
        {/* <CustomButton
          ...
          styles={address ? " bg-[#1f88d9] " : " bg-[#59775ecc] "}
          handleClick={() => {
